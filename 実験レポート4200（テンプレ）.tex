...
\def\subsection{\@startsection {subsection}{1}{\z@}{2.3ex plus -1ex minus -.2ex}{.7 ex plus .2ex}{\Large\bf}}
\def\subsubsection{\@startsection {subsubsection}{1}{\z@}{2.3ex plus -1ex minus -.2ex}{.3 ex plus .2ex}{\large \bf}}
\makeatother
...
%\titleformat*{\subsubsection}{\large\sf}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=14cm]{データ/graph-crop.pdf}
	\caption{グラフ例}
    \label{img/graph}
    \vspace{-1\baselineskip}
\end{figure}
